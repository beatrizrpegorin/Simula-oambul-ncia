...
class Labirinto:
        ...
        for lin in range(self._dim):
            ...
            for col in range(self._dim):
                ...
                if (self.eh_caminho(lin,col)):
                    ...
                    self.desenhar_celula(celula, 'grey')

                    #self.desenhar_pastilha(celula, 'white')
                    self.desenhar_div_horizontal(celula, 'yellow')
                    self.desenhar_div_vertical(celula, 'yellow')
    ...
    def desenhar_div_horizontal(self, celula, cor):
        x,y= celula.coord_turt_centralizada()
    ...
    def desenhar_div_vertical(self, celula, cor):
        x,y= celula.coord_turt_centralizada()
        a,b= celula.coord_matriz()
    ...
    def add_pacman(self, id):
        ...
        pacman = Agente(id, tam_agente, 'red', 'white')
    ...
    def add_fantasma(self, id):
        ...
        tam_agente = self._tam_celula
        f = Agente(id, tam_agente, 'black', 'grey')
    ...
    def eh_celula_ocupada(self, prox_passo, agente_id):
        ...
        '''for k in self.agentes.keys():
            if k != agente_id and agentes[k]._posicao== celula:
                return True
            else:
                return False'''
